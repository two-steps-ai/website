...
const CaseStudyModal: React.FC<CaseStudyModalProps> = ({ study, onClose, onBookCall }) => {
  const { title, gradient, client, industry, description, solution, implementation, icon: IconComponent } = study;
