      ...
      >
        ...
        <div className="relative">
          ...
          <div className="absolute left-6 top-0 bottom-0 w-1">
            <motion.div
              className="h-full bg-gradient-to-b from-blue-500/20 via-purple-500/20 to-blue-500/20 rounded-full"
              initial={{ scaleY: 0 }}
            ...
            >
              <motion.div
                className="absolute inset-x-0 h-32 bg-gradient-to-b from-transparent via-blue-500/40 to-transparent rounded-full"
                animate={{ y: ["-25%", "125%"] }}
                transition={{
                  duration: 2,
                  ease: "linear",
