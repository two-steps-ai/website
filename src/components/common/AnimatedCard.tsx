...
const AnimatedCard: React.FC<AnimatedCardProps> = ({
  ...
  // Disable animations for low performance devices or if reduced motion is preferred.
  ...
  // Handler for when the animation loads.
  const handleAnimationLoad = useCallback(() => {
    setAnimationLoaded(true);
  }, []);

  // Memoize the player event handler.
  ...
  // Determine if the animation overlay should render.
