...
import { preloadComponents } from '../utils/performance/optimizations/bundleOptimization';
...
const Process = React.lazy(() => 
  import('../components/Process')
    ...
    .catch(error => {
      ...
      return { 
        default: React.memo(() => <SectionErrorFallback error={error} />) 
      } as typeof import('../components/Process');
    })
);
...
const FAQ = React.lazy(() => 
  import('../components/FAQ')
    ...
    .catch(error => {
      ...
      return { 
        default: React.memo(() => <SectionErrorFallback error={error} />) 
      } as typeof import('../components/FAQ');
    })
);
